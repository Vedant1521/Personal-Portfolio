...
const useTelegram = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    name: "Vedant Gupta",
    username: "@vedantgupta_dev",
    bio: "Full-Stack Developer & Mathematics and Computing Undergrad | Python, C++, ML enthusiast.",
    phone: "+91 ••••• •••••",
  });
    ...
    if (activeChat.id === "bot") {
      ...
      setTimeout(() => {
        ...
        if (
          ...
          reply =
            "I'm currently open to new roles and freelancing opportunities! Let's schedule a call. Drop me a line at vedant@example.com.";
        }
