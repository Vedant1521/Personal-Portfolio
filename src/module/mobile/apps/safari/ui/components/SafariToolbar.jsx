                ...
                >
                  ...
                  <div className="flex-1 flex items-center justify-center mt-2 bg-zinc-50 rounded-xl border border-zinc-200/50 shadow-inner overflow-hidden select-none relative">
                    {(() => {
                      ...
                      if (urlLower.includes("botlock")) {
                        return (
                          <img
                            src="/projects/botlock.webp"
                            alt="Botlock"
                            className="w-full h-full object-cover object-top"
                          />
                        );
                      }
                      if (urlLower.includes("nexus")) {
                        return (
                          <img
                            src="/projects/nexusai.webp"
                            alt="NexusAI"
                            className="w-full h-full object-cover object-top"
                          />
                        );
                      }
                      if (urlLower.includes("fetchit") || urlLower.includes("npm")) {
                        return (
                          <img
                            src="/projects/fetchit.webp"
                            alt="fetchit"
                            className="w-full h-full object-cover object-top"
                          />
                        );
                      }
                      if (urlLower.includes("neversleep")) {
                        return (
                          <img
                            src="/projects/neversleep.webp"
                            alt="NeverSleep"
                            className="w-full h-full object-cover object-top"
                          />
                        );
