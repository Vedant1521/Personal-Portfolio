...
const Contact = () => {
  ...
  return (
    <>
      <div className="flex flex-col h-full w-full @container bg-[#1c1c1e] rounded-xl overflow-hidden relative">
        <div id="window-header" className="shrink-0 !bg-[#2c2c2e] !border-b-[#3a3a3c] !px-4 !py-2">
          <WindowControls target={"contact"} />
          <h2 className="flex-1 text-center text-sm font-bold text-white/70">Contact Me</h2>
        </div>
