                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold truncate text-left">Resume.pdf</p>
                      <p className="text-[10px] text-gray-400 text-left">2.4 MB â€” Complete</p>
                    </div>
                  </div>
                  <div
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-gray-400 text-left">14.8 MB â€” Complete</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="absolute right-2 top-0 mt-8 w-64 bg-white border border-[#c8cbd0] rounded-xl shadow-xl p-3.5 text-xs z-50 text-gray-700 animate-in fade-in">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold truncate text-left">Resume.pdf</p>
                  <p className="text-[9px] text-gray-400 text-left">2.4 MB â€” Complete</p>
                </div>
              </div>
            </div>
          </div>
