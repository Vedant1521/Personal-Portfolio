const PRESET_PLACES = {
  mumbai: {
    ...
    desc: "Vedant's current location. The financial powerhouse and entertainment capital of India, situated on the coastal edge of the Arabian Sea.",
    lat: 19.076,
    lon: 72.8777,
    bboxWidth: 0.12,
    ...
    steps: [
      ...
      "Arrive at Vedant's Development Lab.",
    ],
  },
  sf: {
    name: "San Francisco",
