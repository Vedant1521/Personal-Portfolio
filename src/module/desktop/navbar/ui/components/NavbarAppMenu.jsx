...
const NavbarAppMenu = ({ activeAppName, openWindow, isAppleMenuOpen, setIsAppleMenuOpen }) => {
      ...
      [
        {
          ...
          onClick: () => {
            ...
            } else if (activeAppName === "Vedant's Portfolio") {
      ...
      [
        {
          ...
          onClick: () => openWindow("safari", { url: PROJECT_1_URL }),
        },
        {
      ...
      [
        {
          ...
          onClick: () => {
            ...
            link.href = "/files/resume.pdf?v=2";
  ...
  return (
    <ul className="nav-links max-sm:hidden" ref={containerRef}>
      ...
      <li
        className="relative rounded select-none hover:bg-white/10"
        onClick={() => window.open(GITHUB_PROFILE, "_blank")}
      >
        GitHub
      </li>
      <li
        className="relative rounded select-none hover:bg-white/10"
        onClick={() => window.open(PROJECT_4_URL, "_blank")}
      >
        NeverSleep
      </li>
    </ul>
