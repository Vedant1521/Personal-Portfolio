      ...
      const response = await fetch("/api/groq/chat", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are Siri, a helpful voice assistant on Vedant Gupta's macOS Portfolio.
Rules:
...
- Vedant's Projects Context:
  1. Botlock: An enforce-at-the-protocol-layer AI agent scraper wall with Solana USDC micropayments.
  2. NexusAI: A production-grade multi-agent platform orchestrating 8 specialized agents via LangGraph.
  3. fetchit: A full-screen terminal UI (TUI) video downloader built with React and Ink.
